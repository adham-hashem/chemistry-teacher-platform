        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IntroductoryVideoUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ShortDescription = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    DetailedDescription = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    Requirements = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    WhatStudentsWillLearn = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LessonSummaryText = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LessonSummaryPdfPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EquationsTablePdfPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WorkPapersPdfPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsFree = table.Column<bool>(type: "bit", nullable: false),
                    MonthAssigned = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_McqQuestions_Exams_ExamId",
                        column: x => x.ExamId,
                        principalTable: "Exams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonAccessCodes_LessonId_UserId",
                table: "LessonAccessCodes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_UserId_LessonId",
                table: "Questions",
                columns: new[] { "UserId", "LessonId" });
